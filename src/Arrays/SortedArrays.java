...
public class SortedArrays {
    ...
    public static int[] getIntegers(int userInput){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter " + userInput + " integer values:\r");
    ...
    public static void printArray(int [] enteredArray){
        for(int i=0; i<enteredArray.length; i++){
            System.out.println("Element "+i+" contents " + enteredArray[i]);
        }
    }
        ...
        for (int i=0;i<unsortedArray.length;i++){
            for (int j =i+1 ; j<unsortedArray.length ; j++){
                if (unsortedArray[i]<unsortedArray[j]) {
                    valueHolder=unsortedArray[i];
                    unsortedArray[i]=unsortedArray[j];
                    unsortedArray[j]=valueHolder;
                }
            }
        }
